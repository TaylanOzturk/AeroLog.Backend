...
namespace AeroLog.Backend.Controllers
{
    public class AirportsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AirportID,AirportName,IATA,ICAO,Latitude,Longitude")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AirportID,AirportName,IATA,ICAO,Latitude,Longitude")] Airport airport)
        {
            if (ModelState.IsValid)
            {
